...
def binary_search_rec_impl(data, n, low, high):
    if high >= low:
        mid = (low + high) // 2
        ...
        if data[mid] == n:
            ...
            return binary_search_rec_impl(data, n, mid + 1, high)
        else:
            return binary_search_rec_impl(data, n, low, mid - 1)
    else:
        return -1


def binary_search_rec(data, n):
    return binary_search_rec_impl(data, n, 0, len(data) - 1)
