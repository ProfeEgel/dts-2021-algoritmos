...
def animate_sorting_algorithm(array, n, max, sorting_generator, title=""):
    ...
    anim = animation.FuncAnimation(fig, func=update_fig,
                                   fargs=(bar_rects, iteration), frames=sorting_generator, interval=50,
                                   repeat=False)
    plt.show()
